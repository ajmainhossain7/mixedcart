...
const Checkout = () => {
    ...
    // Mock cart data for integration demonstration (usually loaded from redux/state)
    const cartItems = [
        {
            product: 'mock1',
            qty: 1,
    ...
    const totalAmount = 48; // Total amount in USD
    ...
    return (
        <div className="dashboard-wrapper">
            <div style={{ display: 'grid', gridTemplateColumns: '7fr 5fr', gap: '48px' }}>
                ...
                <div className="dashboard-content-section" style={{ backgroundColor: 'var(--bg-secondary)', height: 'fit-content' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '15px' }}>
                            <span>Ribbed Ceramic Vase (x1)</span>
                            <span style={{ fontWeight: '500' }}>$48.00</span>
                        </div>
                        <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '16px', display: 'flex', justifyContent: 'space-between', fontSize: '18px', fontWeight: '600' }}>
                            ...
                            <span className="serif-heading" style={{ color: 'var(--text-primary)' }}>$48.00</span>
                        </div>
                    </div>
                </div>
            </div>
